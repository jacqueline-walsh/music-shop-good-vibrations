...
class CheckoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checkout" do
    assert_difference('Checkout.count') do
      post checkouts_url, params: { checkout: { country: @checkout.country, county: @checkout.county, street: @checkout.street, town: @checkout.town } }
    end
  ...
  test "should update checkout" do
    patch checkout_url(@checkout), params: { checkout: { country: @checkout.country, county: @checkout.county, street: @checkout.street, town: @checkout.town } }
